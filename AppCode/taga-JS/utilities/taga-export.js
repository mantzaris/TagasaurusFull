    ...
    save_promise.then( async function(path_chosen) {
        ...
        if(path_chosen.canceled == false) {
            if (!FS.existsSync(path_chosen.filePath)) {
                ...
                FS.copyFileSync( TAGA_FILES_DIRECTORY + PATH.sep + 'test-better3.db', path_chosen.filePath + PATH.sep + 'IMPORT-THIS-FILE-EXPORTED-DB.db', FS.constants.COPYFILE_EXCL)
