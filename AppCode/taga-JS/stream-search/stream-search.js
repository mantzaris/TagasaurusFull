...
async function Stream_Search_Run() {
    ...
    //GenerateTable() //generate the table to view the keywords !!! replace
    ...
    let db_search_delay = 1000 //amount of time the DB has to find data related to a face, in ms
    ...
    //document.getElementById("stream-view1").style.display = 'block'


    // //Init()
    // async function f1() {
    //     stream_ok = await Set_Stream()
    //     if(!stream_ok) { return }
    //     Stream_Search_Run()   }
    // f1()